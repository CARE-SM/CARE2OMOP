...
async def run_etl_workflow(user_request: UserRequest):
    ...
    print(resulting_visit_from_condition)
    ...
    print(resulting_visit_from_measurement)
    ...
    print(resulting_visit_from_observation)
    ...
    print(resulting_visit_from_procedure)
